...
--
-- Servidor: localhost
-- Tiempo de generación: 17-08-2013 a las 20:29:52
...
(497, 'oct', 'tt', 'ttt', 'tt', 'tt', 'tt', 'tt', 'tt', 'tt', 't', 1102, NULL);
...
--
-- Volcar la base de datos para la tabla `film_actor`
--
...
--
-- Volcar la base de datos para la tabla `film_category`
--
...
--
-- Volcar la base de datos para la tabla `offices`
--
...
--
-- Volcar la base de datos para la tabla `orderdetails`
--
...
--
-- Volcar la base de datos para la tabla `productlines`
--
...
(1, 'adminfrp', '81dc9bdb52d04dc20036dbd8313ed055');
